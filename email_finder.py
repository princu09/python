...
#here you add any para and search out all emails //
str = """
...
# you use also this var to find email
...
print("\n-------------------------------------------------------------------------------------------------------------------")
print("\nFor learn how to run and access email_finder, open this file in your editor and learn about this file")
print("\nThank You\n")